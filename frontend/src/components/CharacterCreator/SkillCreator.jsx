  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6 text-white" style={{ fontFamily: 'Geist_Mono' }}>
      <div className="bg-gradient-to-t from-neutral-800 to-neutral-850 border-l-8 border-orange-500 p-6 rounded shadow">
        <h2 className="text-2xl font-bold text-orange-400 border-l-4 border-orange-400 px-3">
          Allocate Attribute Points
        </h2>
        <h3 className="mt-3 text-sm text-white">
        ...
        <p className="mt-3 text-xs text-neutral-500">
          ...
          categories. <br /><br />Each character starts with their attributes at zero. Zero
      ...
      <div className="bg-gradient-to-t from-neutral-800 to-neutral-850 border-l-8 border-orange-500 p-6 rounded shadow">
        ...
        <div className="grid sm:grid-cols-2 gap-2 mt-4">
          {attributeList.map((attr) => (
            <div
              key={attr}
              className="flex justify-between items-center bg-neutral-800/80 px-3 py-2 rounded border border-orange-500/20"
            >
              <span>{attr}</span>
            ...
            <div key={group}>
              ...
              <div className="space-y-2">
                {skillsInGroup.map((skill) => (
                  <div
                    key={skill}
                    className="flex justify-between items-center bg-neutral-800/80 px-3 py-3 rounded min-h-[60px] border border-orange-500/20"
                  >
      ...
      <div className="bg-gradient-to-t from-neutral-800 to-neutral-850 border-l-8 border-orange-500 p-6 rounded shadow">
        ...
        <ul className="space-y-1 text-sm mt-4">
          {specializations.map((s, idx) => (
            <li
              key={idx}
              className="bg-neutral-800/80 px-3 py-1 rounded flex justify-between items-center border border-orange-500/20"
            >
              <div>
