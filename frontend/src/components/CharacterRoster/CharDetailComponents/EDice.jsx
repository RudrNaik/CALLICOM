function Edice({
  ...
  return (
    <div className="mt-6">
      ...
      <div className="flex items-center space-x-4 mt-1 rounded-xs bg-gradient-to-r from-neutral-800 to-neutral-850 border-l-4 border-orange-500 p-2">
        <span className="text-white text-md">
          <span className="text-yellow-400 py-1 px-2 bg-neutral-900 rounded-xs">{emergencyDice}</span> E-Dice available
        </span>
