              ...
              <div className="inline-flex rounded-xl border border-orange-500/40 bg-neutral-900/60 overflow-hidden">
                <button
                  className={`px-4 py-2 text-sm font-semibold ${
                    tab === "loadout" ? "bg-orange-500 text-white" : "text-orange-300 hover:bg-neutral-800"
                  }`}
                ...
                <button
                  className={`px-4 py-2 text-sm font-semibold border-l border-orange-500/40 ${
                    tab === "skills" ? "bg-orange-500 text-white" : "text-orange-300 hover:bg-neutral-800"
                  }`}
      ...
      <div className="w-full space-y-4">
        ...
        <div className="rounded-xl border border-orange-500/50 bg-neutral-900/60 p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            ...
            <ItemCard title={equip.primaryWeapon?.category || "Primary"} value={equip.primaryWeapon?.name || "None"} />
            <ItemCard title={equip.secondaryWeapon?.category || "Secondary"} value={equip.secondaryWeapon?.name || "None"} />
            <ItemCard
              className="md:col-span-2"
              title="Grenades"
              value={`${(equip.grenades?.[0] || "-")} | ${(equip.grenades?.[1] || "-")}`}
            />
          </div>
        </div>
...
function DerivedCard({ label, value }) {
  return (
    <div className="rounded-lg border border-neutral-700 bg-neutral-800/50 p-1">
      <p className="text-[0.60rem] tracking-widest text-neutral-400 px-1">{label}</p>
